    ...
    class Owlbear {
        ...
        update(deltaTime) {
            if (this.game.lastKey == 'Pa') {
                ...
                this.frameY = 3;
            } else if (this.game.lastKey == 'Ra' && this.speedX < 0) {
                this.setSpeed(0, 0);
                this.frameY = 2;
            } else if (this.game.lastKey == 'Pd') {
                this.setSpeed(this.maxSpeed, 0);
                this.frameY = 5;
            } else if (this.game.lastKey == 'Rd' && this.speedX > 0) {
                this.setSpeed(0, 0);
                this.frameY = 4;
            } else if (this.game.lastKey == 'Ps') {
                this.setSpeed(0, this.maxSpeed * 0.6);
                this.frameY = 1;
            } else if (this.game.lastKey == 'Rs' && this.speedY > 0) {
                this.setSpeed(0, 0);
                this.frameY = 0;
            } else if (this.game.lastKey == 'Pw') {
                this.setSpeed(0, -this.maxSpeed * 0.6);
                this.frameY = 7;
            } else if (this.game.lastKey == 'Rw' && this.speedY < 0) {
                this.setSpeed(0, 0);
                this.frameY = 6;
            }
